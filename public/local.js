/* 本地模式适配器：书库存 IndexedDB，解析在前端完成。
   ...
   文件为 UMD 形态：浏览器挂到 window.LocalAdapter；Node 测试可直接 require。 */
"use strict";
...
(function () {
  ...
  function createLocalAdapter(indexedDB) {
  ...
  if (typeof module !== "undefined" && module.exports) {
    module.exports = { createLocalAdapter, parseChapters, splitParagraphs, decodeText };
  } else {
    const enabled = !!window.Capacitor || location.search.includes("local=1");
    window.LocalAdapter = Object.assign({ enabled, decodeText }, createLocalAdapter(indexedDB));
  }
})();
